...
@router.get("", response_model=AnomalyListResponse, summary="List all active maritime anomalies and threat alerts")
def list_anomalies(
    severity: Optional[str] = Query(None, description="Filter by severity: CRITICAL, HIGH, MEDIUM, LOW, or ALL"),
    region: Optional[str] = Query(None, description="Filter by geographical chokepoint/region"),

...
IMPOSSIBLE_SPEED_KNOTS = 55.0  # Speeds > 55 kts indicate teleportation jumps
ALTITUDE_SPOOF_METERS = 50.0   # Marine GPS antenna altitude > 50m ASL indicates ground spoofers
CARRIER_JAM_THRESHOLD_DB = 30.0  # C/N0 below 30 dB indicates RF jamming or degradation

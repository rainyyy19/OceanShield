...
try:
    from models.vessel import RiskLevel, VesselModel
    from schemas.heatmap import (
    ...
    from backend.models.vessel import RiskLevel, VesselModel
...
class HeatmapService:
    ...
    REGIONS_CONFIG = [
        ...
        {
            "id": "reg-coromandel",
            "name": "Coromandel Coast / Bay of Bengal Corridor",
            "center": (13.15, 80.35),
            "bounds": (11.5, 79.0, 15.0, 82.5),
            "primary_threat": "Kinematic Teleportation Jumps & Synthetic Velocity Spikes",
            "base_risk": 89.0,
            "description": "Maritime approaches subject to discontinuous GPS coordinate displacement jumps and extreme velocity spoofing.",
        },
    ]

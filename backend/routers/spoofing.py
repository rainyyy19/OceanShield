...
try:
    from schemas.spoofing import SpoofingConfidenceResponse, FleetConfidenceSummary
    from services.spoofing_service import spoofing_service
except ImportError:
    from backend.schemas.spoofing import SpoofingConfidenceResponse, FleetConfidenceSummary
    from backend.services.spoofing_service import spoofing_service
